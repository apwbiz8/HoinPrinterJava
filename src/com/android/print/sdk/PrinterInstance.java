...
public class PrinterInstance implements Serializable {
    ...
    public int sendByteData(byte[] data) {
        if (data != null) {
            DefaultUtils.Log(TAG, "sendByteData length is: " + data.length);
    ...
    public int printImageNew(Bitmap bitmap) {
        return this.sendByteData(OtherUtils.decodeBitmap(OtherUtils.scalingBitmap(bitmap, 384), 255));
    }
    
    public int printImage(Bitmap bitmap) {
        return this.sendByteData(DefaultUtils.bitmap2PrinterBytes(bitmap, 0));
    }

    public int printImage(Bitmap bitmap, int left) {
        return this.sendByteData(DefaultUtils.bitmap2PrinterBytes(bitmap, left));
    }

    public int printImageStylus(Bitmap bitmap, int multiple) {
        return this.sendByteData(DefaultUtils.bitmap2PrinterBytes_stylus(bitmap, multiple, 0));
    }

    public int printImageStylus(Bitmap bitmap, int multiple, int left) {
        return this.sendByteData(DefaultUtils.bitmap2PrinterBytes_stylus(bitmap, multiple, left));
    }
